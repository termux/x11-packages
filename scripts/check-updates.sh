...
translate_package_name() {
	...
	case "$1" in
		gtk2) translated_name="/hidden/";;
		gtk3) translated_name="gtk";;
		libfm-extra) translated_name="libfm";;
		libunique) translated_name="unique";;
		libvte) translated_name="vte";;
		libwnck) translated_name="/hidden/";;
		openttd-sfx) translated_name="openttd-opensfx";;
		pinentry-gtk) translated_name="pinentry";;
		qemu-system-x86_64) translated_name="qemu";;
		qt5-base) translated_name="qt";;
		st) translated_name="/hidden/";;
		the-powder-toy) translated_name="powder-toy";;
		transmission-gtk) translated_name="transmission";;
		vim-gtk) translated_name="vim";;
		wireshark-gtk) translated_name="/hidden/";;
		xfce4) translated_name="/hidden/";;
		xorg-font-util) translated_name="font-util";;
		xorg-iceauth) translated_name="iceauth";;
		xorg-luit) translated_name="luit";;
		xorg-mkfontscale) translated_name="mkfontscale";;
		xorg-server-xvfb) translated_name="xorg-server";;
		xorg-twm) translated_name="/hidden/";;
		...
		xorg-xhost) translated_name="xhost";;
		xorg-xmessage) translated_name="xmessage";;
		xorg-xrdb) translated_name="xrdb";;
