...
TERMUX_PKG_DEPENDS="xfce4-terminal, xfce4-appfinder, xfce4-calculator-plugin, xfce4-clipman-plugin, xfce4-datetime-plugin, xfce4-dict, xfce4-eyes-plugin, xfce4-mailwatch-plugin, xfce4-netload-plugin, xfce4-notes-plugin, xfce4-notifyd, xfce4-panel-profiles, xfce4-taskmanager, xfce4-timer-plugin, xfce4-wavelan-plugin, xfce4-whiskermenu-plugin, thunar-archive-plugin, parole, leafpad, file-roller, ristretto, gigolo"
