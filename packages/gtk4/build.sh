...
TERMUX_PKG_DEPENDS="adwaita-icon-theme, atk, coreutils, desktop-file-utils, gdk-pixbuf, glib, glib-bin, graphene, gtk-update-icon-cache, libcairo, libepoxy, libxcomposite, libxcursor, libxdamage, libxfixes, libxi, libxinerama, libxrandr, pango, shared-mime-info, ttf-dejavu, libxkbcommon, libandroid-shmem, libwayland, libwayland-protocols, libepoxy, vulkan-loader-android"
TERMUX_PKG_BUILD_DEPENDS="vulkan-headers, xorgproto"
