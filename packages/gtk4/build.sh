...
TERMUX_PKG_EXTRA_CONFIGURE_ARGS+="-Dwayland-backend=false -Ddemos=false -Dbuild-examples=false -Dbuild-tests=false -Dvulkan=disabled -Dprint-cups=disabled -Dprint-cloudprint=disabled"
