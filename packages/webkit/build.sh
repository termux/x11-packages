...
TERMUX_PKG_EXTRA_CONFIGURE_ARGS="-DPORT=GTK -DCMAKE_BUILD_TYPE=RelWithDebInfo -DENABLE_GAMEPAD=OFF -DUSE_SYSTEMD=OFF"
TERMUX_PKG_SHA256=6b1bb3e0efcfcb6e4a8e18b6a5f1cac27cda203d46a7dfbb0f150784a47e908f
TERMUX_PKG_DEPENDS="libtasn1, libcairo, libgcrypt, gtk3, libsoup, libwebp, libxslt, libsecret, woff2, enchant, libhypen, gstreamer, gst-plugins-base" 
