...
TERMUX_PKG_DEPENDS="startup-notification, libxkbcommon, xcb-util-wm, xcb-util-xrm, librsvg"
TERMUX_PKG_BUILD_IN_SRC=true
TERMUX_PKG_EXTRA_CONFIGURE_ARGS="--disable-check LIBS=-landroid-shmem"
