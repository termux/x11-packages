...
TERMUX_PKG_DEPENDS="dconf, gtk3, desktop-file-utils, atk, libcairo, librsvg, libpng, glib, mate-common, mate-desktop, libnotify, pango, libxml2, shared-mime-info, libexif, libxpm, startup-notification"
TERMUX_PKG_EXTRA_CONFIGURE_ARGS="--enable-introspection=no --disable-xmp --disable-packagekit --disable-self-check" 
TERMUX_PKG_BUILD_IN_SRC=true
TERMUX_PKG_RM_AFTER_INSTALL="share/glib-2.0/schemas/gschemas.compiled"

termux_step_pre_configure(){
  PATH=$PATH:$TERMUX_PREFIX/bin NOCONFIGURE=1 ./autogen.sh
}
