...
TERMUX_PKG_DEPENDS="dconf, gtk3, desktop-file-utils, atk, libcairo, librsvg, libpng, glib, mate-common, mate-desktop, libnotify, pango, libxml2, shared-mime-info, libexif, startup-notification"
