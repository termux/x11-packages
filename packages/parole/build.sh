...
TERMUX_PKG_DEPENDS="gtk3, gstreamer, gst-plugins-base, gst-plugins-bad, gst-plugins-good, gst-plugins-ugly, atk, libcairo, dbus-glib, libnotify, pango, libxfce4util, libxfce4ui, xfconf, taglib, x265, x264, libaom, mpg123, libjpeg-turbo, libass"
