...
termux_step_post_make_install() {
	sed -i 's/wayland_scanner=${exec_prefix}\/bin\/wayland-scanner/wayland_scanner=\/usr\/bin\/wayland-scanner/g' \
		/data/data/com.termux/files/usr/lib/pkgconfig/wayland-scanner.pc
}
